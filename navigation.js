...
function loadNavigation() {
    ...
    // Sprawdź czy jesteśmy na index.html lub dokumenty.html
    const path = window.location.pathname;
    const isIndex = path.endsWith('/') || path.endsWith('index.html') || path.split('/').filter(Boolean).length === 0;
    const isDokumenty = path.endsWith('dokumenty.html');
    const useRelativePaths = isIndex || isDokumenty;
    const pathPrefix = useRelativePaths ? '' : '../';
    ...
    header.innerHTML = `
        <div class="navigation-container">
            <div class="navigation-logo-container">
                <img src="${pathPrefix}cropped-logo-1.png" alt="Logo szkoły" class="navigation-logo-img">
                <a href="${pathPrefix}index.html" class="navigation-logo">Szkolna Liga Sportowa</a>
            </div>
            ...
            <div class="navigation-menu-wrapper">
                <ul class="navigation-menu">
                    <li class="navigation-item" data-section="koszykowka">
                        <button class="navigation-link navigation-dropdown-btn">Koszykówka</button>
                        <ul class="navigation-submenu">
                            <li class="navigation-subitem" data-page="wyniki"><a href="${pathPrefix}koszykowka/wyniki.html" class="navigation-sublink">Wyniki</a></li>
                            <li class="navigation-subitem" data-page="terminarz"><a href="${pathPrefix}koszykowka/terminarz.html" class="navigation-sublink">Terminarz</a></li>
                            <li class="navigation-subitem" data-page="zawodnicy"><a href="${pathPrefix}koszykowka/zawodnicy.html" class="navigation-sublink">Zawodnicy</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="navigation-item" data-section="siatkowka">
                        <button class="navigation-link navigation-dropdown-btn">Siatkówka</button>
                        <ul class="navigation-submenu">
                            <li class="navigation-subitem" data-page="wyniki"><a href="${pathPrefix}siatkowka/wyniki.html" class="navigation-sublink">Wyniki</a></li>
                            <li class="navigation-subitem" data-page="terminarz"><a href="${pathPrefix}siatkowka/terminarz.html" class="navigation-sublink">Terminarz</a></li>
                        </ul>
                    </li>
                    
                    <li class="navigation-item" data-page="dokumenty">
                        <a href="${pathPrefix}dokumenty.html" class="navigation-link">Dokumenty</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href = `${pathPrefix}navigation.css`;
    document.head.appendChild(link);
